  ...
  try {
    ...
    const formattedServices = services.map((service) => ({
      ...
      workDetails: {
        ...
        disposableConsumables: service.disposableConsumables,
        ...
        whiteX: service.whiteX,
        whiteY: service.whiteY,
        whiteFl: service.whiteFl,
        redX: service.redX,
        redY: service.redY,
        redFl: service.redFl,
        greenX: service.greenX,
        greenY: service.greenY,
        greenFl: service.greenFl,
        blueX: service.blueX,
        blueY: service.blueY,
        blueFl: service.blueFl,
