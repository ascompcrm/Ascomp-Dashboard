...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    | `/admin/dashboard/field-workers/${SafeSlug<T>}`
    | `/admin/dashboard/sites/${SafeSlug<T>}`
    | `/admin/dashboard/sites/${SafeSlug<T>}/projectors/${SafeSlug<T>}`
    | `/api/admin/field-workers/${SafeSlug<T>}/work-history`
    | `/api/admin/sites/${SafeSlug<T>}`
